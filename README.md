...
- 🎓 3rd Year — Information Systems & Technologies  
- 🏛️ Atatürk University  
- 🏢 Defense Industry Intern  
- 🧠 Focus: Real-Time Autonomous Systems  

I build **low-level control systems**,  
design **real-time perception pipelines**,  
and develop **robust embedded intelligence architectures**.
...
| Field | Focus Area |
|-------|------------|
| 🛩️ UAV Systems | Flight Control, PID Loops, Stability Logic |
| 👁️ Computer Vision | OpenCV, Object Tracking, Detection Pipelines |
| 🤖 Robotics | Gait Algorithms, Motion Control, Kinematics |
| 🧠 Sensor Fusion | IMU + Vision Integration |
| ⚙️ Embedded Systems | Real-Time C Development |
...
- 🛩️ UAV Flight Controller (C)
- 👁️ Real-Time Target Tracking System
- 🤖 Quadruped Robot Gait Optimization
- 🧠 Embedded Sensor Fusion Prototype
...
- Robust Software for Physical Systems  
